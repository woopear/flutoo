class ConditionConstant {
  /// create condition
  static String createMessageSucces = "Condition créée avec succès";
  static String createMessageError = "Impossible de creer la condition";
  static String createBtn = "Ajouter";
